      ...
      <div className="data-card overflow-hidden">
        <div className="px-6 py-10 sm:p-12">
          ...
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl sm:text-4xl font-heading font-black mb-4 text-gradient-brand">
              {locale === "uk" ? "Про проєкт" : "About Project"}
            </h2>
            <div className="h-1 w-20 bg-gradient-to-r from-[#008E83] to-[#93E5D6] rounded-full mx-auto md:mx-0"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              {leftColumn.map((paragraph, index) => (
                <p key={`left-${index}`} className="text-sm sm:text-base leading-relaxed" style={{ color: 'var(--foreground-secondary)' }}>
                  {paragraph}
                </p>
              ))}
            </div>
            ...
            <div className="space-y-6">
              {rightColumn.map((paragraph, index) => (
                <p key={`right-${index}`} className="text-sm sm:text-base leading-relaxed" style={{ color: 'var(--foreground-secondary)' }}>
                  {paragraph}
                </p>
              ))}
            </div>
